...
* dosage.doseAndRate.doseQuantity.unit = "Milligrams (mg)"
* dosage.route = $NEMSIS#9927035
* dosage.timing.code = http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation#QD
...
* dosage.doseAndRate.doseQuantity.unit = "Milligrams (mg)"
* dosage.route = $NEMSIS#9927035
* dosage.timing.code = http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation#BID
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
* effectiveDateTime = "2021-10-06T10:53:40-07:00"
...
* medicationReference = Reference(Medication/16532367-9ba3-4d2f-bbb7-43b0a6b17997)
* dosage.doseAndRate.doseQuantity.value = 12
* dosage.doseAndRate.doseQuantity.unit = "Liters Per Minute (LPM [gas])"
* dosage.route = $NEMSIS#9927065
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
* effectiveDateTime = "2021-10-06T10:53:40-07:00"
...
* medicationReference = Reference(Medication/06af537f-8ead-4b0d-85ee-6c0da2ada4b2)
* dosage.doseAndRate.doseQuantity.value = 1
* dosage.doseAndRate.doseQuantity.unit = "Milligrams (mg)"
* dosage.route = $NEMSIS#9927023
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
* effectiveDateTime = "2021-10-06T10:53:40-07:00"
...
* medicationReference = Reference(Medication/955427a5-3d44-4dfe-82a4-da83c234e7d4)
* dosage.doseAndRate.doseQuantity.value = 5
* dosage.doseAndRate.doseQuantity.unit = "Milligrams per Kilogram (mg/kg)"
* dosage.route = $NEMSIS#9927023
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
* effectiveDateTime = "2021-10-06T10:53:40-07:00"
