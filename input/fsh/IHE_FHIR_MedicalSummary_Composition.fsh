...
* relatesTo.target[x] only Identifier or Reference(Composition or CompositionUvIps or ClinicalDocumentComposition)
...
* section[sectionProblems] obeys ihe-pcc-comp-1
...
* section[sectionAllergies] obeys ihe-pcc-comp-1
...
* section[sectionMedications] obeys ihe-pcc-comp-1
...
//* section[sectionPayers].text ^extension[http://hl7.org/fhir/StructureDefinition/obligation][=].extension[actor].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/Consumer"
* section[sectionPayers].entry only Reference(Observation or DocumentReference or Coverage or Contract or InsurancePlan)
* section[sectionPayers].entry ^slicing.discriminator[+].type = #profile
* section[sectionPayers].entry ^slicing.discriminator[=].path = "resolve()"
* section[sectionPayers].entry ^slicing.rules = #open
* section[sectionPayers].entry ^short = "information about the patient's sources of payment."
* section[sectionPayers].entry ^definition = "Financial instrument which may be used to reimburse or pay for health care products and services. Includes both insurance and self-payment."
