...
* extension[Race].value[x] = valueCodeableConcept from (example)
//Note: In some jurisdictions, it is prohibited to send race and/or ethnicity. Use of this option may be constrained by national extension.  

Extension: Ethnicity
Id: Ethnicity
Description: "Patient’s ethnicity"
* extension[Ethnicity].value[x] = valueCodeableConcept from DetailedEthnicity (example)
//Note: In some jurisdictions, it is prohibited to send race and/or ethnicity. Use of this option may be constrained by national extension.  
