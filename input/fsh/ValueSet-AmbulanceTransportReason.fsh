...
* SYSTEM#not-recorded		"The value is not available because the observation procedure (test, etc.) was not recorded."
* SYSTEM#not-reporting	"The value is not available because the observation procedure (test, etc.) was not being reported."
* SYSTEM#unable-to-complete	"The value is not available because the observation procedure (test, etc.) was not able to be completed."
* SYSTEM#finding-not-present	"The value is not available because the value for the observation procedure (test, etc.) was not present."
* SYSTEM#patient-refused	"The value is not available because the patient refused the observation procedure (test, etc.)."
* SYSTEM#patient-unresponsive	"The value is not available because the patient was unresponsive and the observation procedure (test, etc.) was not able to be performed."
