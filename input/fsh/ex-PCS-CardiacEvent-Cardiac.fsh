Instance:   ex-PCS-CardiacEvent-Indicator-Cardiac
InstanceOf: Observation
Title: "Example of cardiact Arrest event entires"
Description:      "holding typical values for Cardiac arrest event"
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* status = #final
* id = "c099d17e-b0fa-4a89-bd75-ee9c7d855d76"
* code = $loinc#67502-5
* value[x] = $NEMSIS#3001003
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* status = #final
* id = "35fc4ee1-fe35-4b68-903e-505085f676fe"
* code = $loinc#72115-9
* value[x] [+] = $loinc#LA17060-7
* value[x] [+] = $loinc#LA17061-5
* value[x] [+] = $loinc#LA17062-3
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* status = #final
* id = "1853f614-34cc-4fb2-9cf5-ceb562cb53a2"
* code = $loinc#67505-8
* value[x] [+] = $loinc#LA18020-0
* value[x] [+] = $loinc#LA18022-6
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* status = #final
* id = "3d91976c-48f4-4650-806a-88d99af248fc"
* code = $loinc#67510-8
* value[x] [+] = $loinc#LA17750-3
* value[x] [+] = $loinc#LA17753-7
* value[x] [+] = $loinc#LA17755-2
* value[x] [+] = $NEMSIS#3009001
