Profile:        IhePCSStrokeScaleScoreUSA
Parent:         Observation
Id:             IHE.PCS.StrokeScaleScoreUSA
Title:          "IHE PCS Stroke Scale Score USA Observation"
...
* value[x].CodeableConcept.coding from valueset http://loinc.org#LL1846-6 (required)
* status = #final
