...
* type = http://hl7.org/fhir/ValueSet/allergy-intolerance-type#allergy
* clinicalStatus = http://hl7.org/fhir/ValueSet/allergyintolerance-clinical#active
* category = http://hl7.org/fhir/ValueSet/allergy-intolerance-category#medication
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* type = http://hl7.org/fhir/ValueSet/allergy-intolerance-type#allergy
* category = http://hl7.org/fhir/ValueSet/allergy-intolerance-category#environment
* clinicalStatus = http://hl7.org/fhir/ValueSet/allergyintolerance-clinical#active
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* type = http://hl7.org/fhir/ValueSet/allergy-intolerance-type#allergy
* category = http://hl7.org/fhir/ValueSet/allergy-intolerance-category#food
* clinicalStatus = http://hl7.org/fhir/ValueSet/allergyintolerance-clinical#active
