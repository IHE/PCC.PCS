...
* vaccineCode = 	http://hl7.org/fhir/ValueSet/vaccine-code#20 "diphtheria, tetanus toxoids and acellular pertussis vaccine"
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* vaccineCode = 	http://hl7.org/fhir/ValueSet/vaccine-code#141 "Influenza, seasonal, injectable"
* patient = Reference(Patient/ex-Patient-Elina-R-Macias)
...
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* vaccineCode = 	http://hl7.org/fhir/ValueSet/vaccine-code#3 "measles, mumps and rubella virus vaccine"
* patient = Reference(Patient/ex-Patient-Elina-R-Macias)
* occurrenceDateTime = "1950"
